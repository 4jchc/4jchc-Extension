...
class XMGTabBarController: UITabBarController {
    ...
    func addChildViewControllers() {
        ...
        addChildVc("最新", image: "tabBar_new_icon", selectedImage: "tabBar_new_click_icon",childVc: <#XMGEssenceViewController#>())
        
        addChildVc("关注", image: "tabBar_friendTrends_icon", selectedImage: "tabBar_friendTrends_click_icon",childVc: <#XMGEssenceViewController#>())
        
        addChildVc("我", image: "tabBar_me_icon", selectedImage: "tabBar_me_click_icon",childVc: <#XMGEssenceViewController#>())
        */
    }
